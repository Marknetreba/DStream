...
//        .option(IgniteDataFrameSettings.OPTION_CONFIG_FILE, "conf.xml")
//        .option(IgniteDataFrameSettings.OPTION_TABLE, "data")
//        .option(IgniteDataFrameSettings.OPTION_CREATE_TABLE_PRIMARY_KEY_FIELDS, "ip")
//        .save()
...
case class Record(time: String, category: String, ip: String, event: String)
